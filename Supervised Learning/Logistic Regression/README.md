...
<img src="https://render.githubusercontent.com/render/math?math=\hat y^i=\beta_{0}%2B\beta_{1}x_{1}^i%2B...\beta_{p}x_{p}^i"><img src="https://render.githubusercontent.com/render/math?math=%2B\beta_{p}x_{p}^i">
